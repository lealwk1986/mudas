...
<a href="javascript:void(0)" class="closebtn" onclick="closeNav2()">&times;</a>
 ...
 <?php endif; ?>
     ...
     <span style="font-size:30px;cursor:pointer;float: left;margin-top: 40px;" onclick="openNav()">&#9776;</span>
  <span style="font-size:30px;cursor:pointer; float: right; margin-right: 2px;margin-top: 40px;" onclick="openNav2()">&#9776; </span>

    <div class="main2" id="mySidenav" style="height: 600px">
...
function closeNav() {
  document.getElementById("row").style.width = "0";
}
function openNav2() {
