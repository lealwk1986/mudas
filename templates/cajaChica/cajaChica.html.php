...
<div class="main" id="main">
  ...
  <p class=titulounidad >BIENVENIDO A LA SECCION DE CAJA CHICA</p>
...
function ver(v1) {
 ...
 xmlhttp2.open("GET", "/cajachica/veri?id="+v1, true); 
 xmlhttp2.send();   
...
function editar() {
 ...
 xmlhttp2.open("GET", "/cajachica/editari?id="+id, true); 
 xmlhttp2.send();   
...
function editar2(v1) {
 ...
 xmlhttp2.open("GET", "/cajachica/editari?id="+v1, true); 
 xmlhttp2.send();   
...
function nuevo(){
 ...
 xmlhttp2.open("GET", "/cajachica/nuevo?id_dep="+id, true); 
 xmlhttp2.send();  
}    
	
Nav_02("/navegador/cajachica","side");
