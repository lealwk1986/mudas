...
<div class="content_ajax">
  <p class=titulounidad >BIENVENIDO A LA SECCION DE REPORTES</p>
    ...
    var myObj = JSON.parse(this.responseText);
      ...
      myObj.forEach(
			function myFunction(value, index, array) {
             txt_mp = txt_mp + '<li><a href="#" class="accordion" onclick="ver('+value[0]+')">'+value[1] + ' '+value[2]+ ' '+value[3]+ ' '+value[4]+'</a><a class="oculto"  style="display: none" href="#">'+ value[1]+' ' + value[2]+'</a></li>';
			}
		);
...
function ver(v1) {
 ...
 xmlhttp2.open("GET", "/reporte/veri?id="+v1+"&grupo=<?=$grupo?>", true); 
 xmlhttp2.send();   
...
function editarR(v1,v2) {
 ...
 xmlhttp2.open("GET", "/reporte/editarregistro?datoreporte_id="+v1+"&reporte_id="+v2, true); 
 xmlhttp2.send();   
...
function editar() {
 ...
 xmlhttp2.open("GET", "/reporte/editari?id="+id+"&grupo=<?=$grupo?>", true); 
 xmlhttp2.send();   
...
function editar2(v1) {
 ...
 xmlhttp2.open("GET", "/reporte/editari?id="+v1+"&grupo=<?=$grupo?>", true); 
 xmlhttp2.send();   
...
function nuevo(){
 ...
 xmlhttp2.open("GET", "/reporte/nuevo?id_dep="+id+"&grupo=<?=$grupo?>", true); 
 xmlhttp2.send();  
}    
	
function printDiv2() { 
             var printContents = document.getElementById('conten_ajax').innerHTML;
...
Nav_02("/navegador/reporte?grupo="+idgrupo,"side");
