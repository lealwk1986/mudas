...
<div class="content_ajax">
  <p class=titulounidad >BIENVENIDO A LA SECCION DE INVENTARIO</p>

	<div class="slideshow-container">

<div class="mySlides fade">
  
  <img src="/doc?archivo=inventario1.png&ruta=/pagina/doc/imag" style="padding: 10px;" width=620px alt=""  >
  
</div>

<div class="mySlides fade">
  
  <img src="/doc?archivo=inventario2.png&ruta=/pagina/doc/imag" style="padding: 10px;" width=620px alt="" >
  
</div>

<div class="mySlides fade">
 
  <img src="/doc?archivo=inventario3.png&ruta=/pagina/doc/imag" style="padding: 10px;" width=620px alt="">
    ...
    var myObj = JSON.parse(this.responseText);
      ...
      myObj.forEach(
			function myFunction(value, index, array) {
             txt_mp = txt_mp + '<li><a href="#" class="accordion" onclick="ver('+value[0]+')">'+value[1] + ' '+value[2]+' '+ value[3]+'</a><a class="oculto"  style="display: none" href="#">'+ value[1]+' ' + value[2]+' '+ value[3]+' '+ value[4]+' '+'</a></li>';
			}
		);
...
function ver(v1) {
 ...
 xmlhttp2.open("GET", "/inventario/veri?id="+v1, true); 
 xmlhttp2.send();   
...
function editar() {
 ...
 xmlhttp2.open("GET", "/inventario/editari?id="+id, true); 
 xmlhttp2.send();   
...
function editar2(v1) {
 ...
 xmlhttp2.open("GET", "/inventario/editari?id="+v1, true); 
 xmlhttp2.send();   
...
function nuevo(){
 ...
 xmlhttp2.open("GET", "/inventario/nuevo?id_dep="+id, true); 
 xmlhttp2.send();  
}    
	
Nav_02("/navegador/inventario","side");
