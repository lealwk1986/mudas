...
<div class="main" id="main">
  ...
  <p class=titulounidad >BIENVENIDO A LA SECCION DE LIBRO DE ACTAS</p>

	<div class="slideshow-container">

<div class="mySlides fade">
  
  <img src="/doc?archivo=libro1.png&ruta=/pagina/doc/imag" style="padding: 10px;" width=620px alt=""  >
  
</div>

<div class="mySlides fade">
  
  <img src="/doc?archivo=libro2.png&ruta=/pagina/doc/imag" style="padding: 10px;" width=620px alt="" >
  
</div>

<div class="mySlides fade">
 
  <img src="/doc?archivo=libro3.png&ruta=/pagina/doc/imag" style="padding: 10px;" width=620px alt="">
    ...
    var myObj = JSON.parse(this.responseText);
      ...
      myObj.forEach(
			function myFunction(value, index, array) {
             txt_mp = txt_mp + '<li><a href="#" class="accordion" onclick="ver('+value[0]+')">'+value[1] + ' '+value[2]+'</a><a class="oculto"  style="display: none" href="#">'+ value[1]+' ' + value[2]+' '+ value[3]+' '+ value[4]+' '+'</a></li>';
			}
		);
...
function ver(v1) {
 ...
 xmlhttp2.open("GET", "/libroacta/veri?id="+v1, true); 
 xmlhttp2.send();   
...
function editarR(v1,v2) {
 ...
 xmlhttp2.open("GET", "/libroacta/editarregistro?registro_id="+v1+"&libroacta_id="+v2, true); 
 xmlhttp2.send();   
...
function editar() {
 ...
 xmlhttp2.open("GET", "/libroacta/editari?id="+id, true); 
 xmlhttp2.send();   
...
function editar2(v1) {
 ...
 xmlhttp2.open("GET", "/libroacta/editari?id="+v1, true); 
 xmlhttp2.send();   
...
function nuevo(){
 ...
 xmlhttp2.open("GET", "/libroacta/nuevo?id_dep="+id, true); 
 xmlhttp2.send();  
}    
	
Nav_02("/navegador/libroacta","side");
